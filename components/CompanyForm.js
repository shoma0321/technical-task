...
export default function CompanyForm({ company, onSuccess }) {
  ...
  const handleSubmit = async event => {
    ...
    const response = company
      ? await axios.put(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/companies/${company.id}`, { code, name, status, nameKana, postalCode, address, representativeName, representativeNameKana, phoneNumber,profit2022, profit2021, profit2020, sales2022, sales2021, sales2020, memo })
